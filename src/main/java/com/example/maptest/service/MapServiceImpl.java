...
public class MapServiceImpl implements MapService {
    ...
    public void iterateAndDeleteOriginalMap(Map<String, List<String>> originalMap) {
        ...
        // Not worked
        /*ConcurrentMap<String, List<String>> clonedMap = new ConcurrentHashMap<>(originalMap);*/
